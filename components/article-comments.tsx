...
export function ArticleComments({ articleId, articlePath }: { articleId: string; articlePath: string }) {
  ...
  return <section className="article-comments" aria-labelledby={headingId}>
    ...
    <p className="comments-note">GitHub 계정으로 댓글을 남길 수 있습니다.</p>
    <div className="comments-widget">
      <Giscus id={'giscus-' + articleId} {...giscusConfig} mapping="specific" term={articlePath} strict="1" reactionsEnabled="0" emitMetadata="0" inputPosition="top" theme="light" lang="ko" loading="lazy" />
    </div>
