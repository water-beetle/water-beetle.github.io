...
우주 생활 게임 개발 기록. 날짜별 글 목록과 개별 읽기 페이지, 최적화 메모를 제공합니다. 밝은 단색 바탕에 한국어 본문과 실제 작업 이미지를 중심으로 구성합니다.
...
2026년 9월 25일 편집 개편: 개발일지 14편의 제목·도입·본문을 작업 기록 문체로 다시 쓰고, 최적화 메모의 제목·목차·요약을 정리했습니다. 측정값과 코드·출처는 유지합니다. 홈의 반복 카드와 두 열 전체 본문을 없애고 `/devlog/[slug]/`에 개별 글을 제공합니다. 영어 장식 문구와 별 배경을 제거했으며, 과거 링크의 앵커와 댓글 식별자는 보존합니다.
