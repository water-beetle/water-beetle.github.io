...
2026년 9월 25일 회고 개발일지 7편(LOG 008~014)을 `lib/september-devlogs.ts`에 추가했습니다. 집과 마당, 편의점, 운석 예보, 요격기, MULE, 흙 채취 카트, 시작 화면을 다룹니다. 작성일과 실제 작업 기간을 구분하고 최신 적용과 과거 촬영본, 미구현·미검증 범위를 각 글에 표시했습니다. 원본 화면의 촬영 맥락은 `ASSETS.md`에 기록합니다.
